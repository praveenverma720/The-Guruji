...
public class EductionSubSubjectRecyclerAdapter extends RecyclerView.Adapter<EductionSubSubjectRecyclerAdapter.TrickHolder> {
    ...
    public EductionSubSubjectRecyclerAdapter(Context context, EducationSubjectResModal dataModels){
    ...
    public void onBindViewHolder(@NonNull final TrickHolder holder, final int position) {
        ...
        holder.subjectNameTV.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("comefrom","subjectList");
